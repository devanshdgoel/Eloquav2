...
async def enhance_text_route(
    ...
    # Generate TTS audio via ElevenLabs and return a URL the client downloads.
    # The file is created synchronously within this request, so by the time the
    # client receives audio_url the file is guaranteed to exist on this server.
    # Non-fatal: if TTS fails the client still shows the transcript and hides
    # the play button.
    audio_url = None
